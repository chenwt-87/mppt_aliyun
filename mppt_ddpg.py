...
my_actions = np.array([-15, -10, -5, -3, -2, -1, -0.1, 0, 0.1, 1, 2, 3, 5, 10, 15, 25]) / 56
...
if __name__ == '__main__':
    ...
    stop_callback = StopTrainingOnRewardThreshold(reward_threshold=700, verbose=1)  # 设置奖励阈值为200，即reward达到200后停止训练
    ...
    if 0:
        ...
        # agent = sb3.A2C.load(AGENT_CKP_PATH)
        obs = env.reset()
